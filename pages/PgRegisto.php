<html>
    <head>
        ...
        <title>Registo - Roda Expresso</title>
        <style>
            body {
        ...
        <div class="container">
            ...
            <form action="registo.php" method="POST">
                <div class="input-container">
                    <label for="nome"><img src="../images/pessoa.png"></label>
                    <input type="text" id="nome" name="nome" placeholder="Nome de utilizador" required>
                </div>
                <div class="input-container">
                ...
                <div class="input-container">
                    <label for="confirm_password"><img src="../images/password.png"></label>
