<?php
    ...
    $sql = "SELECT COUNT(*) as total FROM utilizador WHERE tipo_utilizador = '" . UTILIZADOR_POR_VALIDAR . "'";
            ...
            <div class="notification-dropdown" id="notificationDropdown">
                ...
                <?php if ($pendentes > 0): ?>
                    <div class="notification-item">
                        Tem <?php echo $pendentes; ?> novo(s) registo(s) pendente(s) de aprovação.
                    </div>
                    <a href="aprovacaoRegisto.php" class="view-all">Ver todos</a>
                <?php else: ?>
                    ...
                    .then(data => {
                        if (data.count > 0) {
                            ...
                            dropdown.innerHTML = `
                                <div class="notification-header">Notificações</div>
                                <div class="notification-item">
                                    Você tem ${data.count} novo(s) registro(s) pendente(s) de aprovação.
                                </div>
                                <a href="aprovacaoRegisto.php" class="view-all">Ver todos</a>
                            `;
                        }
