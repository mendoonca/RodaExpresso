...
<body>
    ...
    <div class="container">
        <!-- Gráfico de Análise de Atendimentos -->
        ...
        <!-- Gráfico de Horários de Maior Movimento -->
    ...
    <script>
        ...
        const atendimentosData = meses.map(() => Math.floor(Math.random() * 100) + 50);
        
        // Gerar dados aleatórios para o gráfico de linha
        const movimentoData = horarios.map(() => Math.floor(Math.random() * 80) + 30);
